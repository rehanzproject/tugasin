...
<div class="container mt-5">
    <h1 class="text-left mb-2 p-2" style="font-size: 2rem; font-weight: bold;">Tambah Tugas Baru</h1>  
    <form action="{{ route('tasks.store') }}" method="POST" class="p-4 border rounded shadow-lgform-container"style="backdrop-filter: blur(5px); background-color: rgba(255, 255, 255, 0.5); border-radius: 8px">
        @csrf

        <div class="row mb-4 align-items-center">
            <label for="title" class="col-md-2 col-form-label fw-bold text-dark">Judul:</label>
            <div class="col-md-10">
                <input type="text" id="title" name="title" class="form-control form-control-lg rounded-pill form-input" placeholder="Masukkan judul tugas" required>
            </div>
        </div>
        ...
        <div class="row mb-4 align-items-center">
            ...
            <div class="col-md-10">
                <select id="category" name="category" class="form-select form-select-lg rounded-pill form-input" required>
        ...
        <div class="row mb-4 align-items-center">
            ...
            <div class="col-md-10">
                <textarea id="description" name="description" class="form-control form-control-lg rounded form-input" rows="5" placeholder="Masukkan deskripsi tugas"></textarea>
            </div>
        </div>
        ...
        <div class="row mb-4 align-items-center">
            ...
            <div class="col-md-10">
                <input type="datetime-local" id="deadline" name="deadline" class="form-control form-control-lg rounded-pill form-input" required>
            </div>
        </div>

        <div class="form-group">
    <label for="notification_minutes">Notifikasi</label>
    <input type="number" name="notification_minutes" id="notification_minutes" class="form-control" placeholder="Menit sebelum deadline" value="{{ old('notification_minutes') }}">
</div>

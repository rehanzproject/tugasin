...
<div class="container mt-5">
    <h1 class="text-left mb-2 p-2" style="font-size: 2rem; font-weight: bold;">Tambah Kategori Baru</h1>
    <form action="{{ route('categories.store') }}" method="POST" class="p-4 border rounded shadow-lgform-container"style="backdrop-filter: blur(5px); background-color: rgba(255, 255, 255, 0.5); border-radius: 8px">
        @csrf

        <div class="row mb-4 align-items-center p-4">
            <label for="name" class="col-md-2 col-form-label fw-bold text-dark pt-2">Nama Kategori:</label>
            <div class="col-md-10">
                <input type="text" id="name" name="name" class="form-control form-control-lg rounded-pill form-input p-4" placeholder="Masukkan nama kategori" required>
            </div>
        </div>
